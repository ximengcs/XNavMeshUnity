...
namespace XFrame.PathFinding.RVO
{
    ...
    public struct RVOMath
    {
         ...
         */
        public static float abs(XVector2 vector)
        {
         ...
         */
        public static float absSq(XVector2 vector)
        {
         ...
         * is to be computed.</param>
         */
        public static XVector2 normalize(XVector2 vector)
        {
         ...
         * matrix.</param>
         */
        internal static float det(XVector2 vector1, XVector2 vector2)
        {
         ...
         * be calculated.</param>
         */
        internal static float distSqPointLineSegment(XVector2 vector1, XVector2 vector2, XVector2 vector3)
        {
         ...
         * calculated.</param>
         */
        internal static float leftOf(XVector2 a, XVector2 b, XVector2 c)
        {
            return det(a - c, b - a);
        }

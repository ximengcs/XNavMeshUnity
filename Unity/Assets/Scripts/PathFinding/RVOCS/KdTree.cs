...
namespace XFrame.PathFinding.RVO
{
    ...
    internal class KdTree
    {
         ...
         * tested.</param>
         */
        internal bool queryVisibility(XVector2 q1, XVector2 q2, float radius)
        {
...

            {
                ...
                for (int j = 0; j < obstacles.Count; ++j)
                {
                    ...
                    else
                    {
                        ...
                        XVector2 splitPoint = obstacleJ1.point_ + t * (obstacleJ2.point_ - obstacleJ1.point_);
         ...
         * <param name="node">The current obstacle k-D node.</param>
         */
        private bool queryVisibilityRecursive(XVector2 q1, XVector2 q2, float radius, ObstacleTreeNode node)
        {
            if (node == null)
            {
                return true;

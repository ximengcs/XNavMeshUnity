...
namespace XFrame.PathFinding.RVO
{
    /**
    ...
    internal class Agent
    {
        ...
        internal XVector2 position_;
        internal XVector2 prefVelocity_;
        internal XVector2 velocity_;
        internal int id_ = 0;
        ...
        internal void computeNewVelocity()
        {
            ...
            for (int i = 0; i < obstacleNeighbors_.Count; ++i)
            {
                ...
                XVector2 relativePosition1 = obstacle1.point_ - position_;
                XVector2 relativePosition2 = obstacle2.point_ - position_;
                ...
                XVector2 obstacleVector = obstacle2.point_ - obstacle1.point_;
                ...
                if (s < 0.0f && distSq1 <= radiusSq)
                {
                    ...
                    {
                        line.point = new XVector2(0.0f, 0.0f);
                        line.direction = RVOMath.normalize(new XVector2(-relativePosition1.Y, relativePosition1.X));
                        orcaLines_.Add(line);
                    }
                ...
                else if (s > 1.0f && distSq2 <= radiusSq)
                {
                    ...
                    {
                        line.point = new XVector2(0.0f, 0.0f);
                        line.direction = RVOMath.normalize(new XVector2(-relativePosition2.Y, relativePosition2.X));
                        orcaLines_.Add(line);
                    }
                ...
                XVector2 leftLegDirection, rightLegDirection;
                ...
                if (s < 0.0f && distSqLine <= radiusSq)
                {
                    ...
                    leftLegDirection = new XVector2(relativePosition1.X * leg1 - relativePosition1.Y * radius_, relativePosition1.X * radius_ + relativePosition1.Y * leg1) / distSq1;
                    rightLegDirection = new XVector2(relativePosition1.X * leg1 + relativePosition1.Y * radius_, -relativePosition1.X * radius_ + relativePosition1.Y * leg1) / distSq1;
                }
                else if (s > 1.0f && distSqLine <= radiusSq)
                {
                    ...
                    leftLegDirection = new XVector2(relativePosition2.X * leg2 - relativePosition2.Y * radius_, relativePosition2.X * radius_ + relativePosition2.Y * leg2) / distSq2;
                    rightLegDirection = new XVector2(relativePosition2.X * leg2 + relativePosition2.Y * radius_, -relativePosition2.X * radius_ + relativePosition2.Y * leg2) / distSq2;
                }
                else
                {
                    /* Usual situation. */
                ...
                XVector2 leftCutOff = invTimeHorizonObst * (obstacle1.point_ - position_);
                XVector2 rightCutOff = invTimeHorizonObst * (obstacle2.point_ - position_);
                XVector2 cutOffVector = rightCutOff - leftCutOff;
                ...
                if ((t < 0.0f && tLeft < 0.0f) || (obstacle1 == obstacle2 && tLeft < 0.0f && tRight < 0.0f))
                {
                    ...
                    XVector2 unitW = RVOMath.normalize(velocity_ - leftCutOff);

                    line.direction = new XVector2(unitW.Y, -unitW.X);
                ...
                else if (t > 1.0f && tRight < 0.0f)
                {
                    ...
                    XVector2 unitW = RVOMath.normalize(velocity_ - rightCutOff);
                ...
                if (distSqCutoff <= distSqLeft && distSqCutoff <= distSqRight)
                {
                    ...
                    line.direction = -obstacle1.direction_;
                    line.point = leftCutOff + radius_ * invTimeHorizonObst * new XVector2(-line.direction.Y, line.direction.X);
                    orcaLines_.Add(line);
                ...
                line.point = rightCutOff + radius_ * invTimeHorizonObst * new XVector2(-line.direction.Y, line.direction.X);
                orcaLines_.Add(line);
            }
            ...
            for (int i = 0; i < agentNeighbors_.Count; ++i)
            {
                ...
                XVector2 relativePosition = other.position_ - position_;
                XVector2 relativeVelocity = velocity_ - other.velocity_;
                ...
                {
                    /* No collision. */
                    XVector2 w = relativeVelocity - invTimeHorizon * relativePosition;
                    ...
                    else
                    {
                        ...
                        {
                            /* Project on left leg. */
                            line.direction = new XVector2(relativePosition.X * leg - relativePosition.Y * combinedRadius, relativePosition.X * combinedRadius + relativePosition.Y * leg) / distSq;
                        }
                        else
                        {
                            /* Project on right leg. */
                ...
                else
                {
                    ...
                    /* Vector from cutoff center to relative velocity. */
                    XVector2 w = relativeVelocity - invTimeStep * relativePosition;
         ...
         * </param>
         */
        private bool linearProgram1(IList<Line> lines, int lineNo, float radius, XVector2 optVelocity, bool directionOpt, ref XVector2 result)
        {
         ...
         * </param>
         */
        private int linearProgram2(IList<Line> lines, float radius, XVector2 optVelocity, bool directionOpt, ref XVector2 result)
        {
            if (directionOpt)
            {
                /*
         ...
         * </param>
         */
        private void linearProgram3(IList<Line> lines, int numObstLines, int beginLine, float radius, ref XVector2 result)
        {
            float distance = 0.0f;
            ...
            for (int i = beginLine; i < lines.Count; ++i)
            {
                if (RVOMath.det(lines[i].direction, lines[i].point - result) > distance)
                {
                    ...
                    XVector2 tempResult = result;
                    if (linearProgram2(projLines, radius, new XVector2(-lines[i].direction.Y, lines[i].direction.X), true, ref result) < projLines.Count)
                    {
                        /*

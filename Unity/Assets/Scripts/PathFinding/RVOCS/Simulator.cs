...
namespace XFrame.PathFinding.RVO
{
    ...
    public class Simulator
    {
         ...
         * agent.</param>
         */
        public int addAgent(XVector2 position)
        {
         ...
         * this agent.</param>
         */
        public int addAgent(XVector2 position, float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, XVector2 velocity)
        {
            Agent agent = new Agent();
            agent.id_ = agents_.Count;
         ...
         * </remarks>
         */
        public int addObstacle(IList<XVector2> vertices)
        {
            if (vertices.Count < 2)
            {
                return -1;
         ...
         */
        public XVector2 getAgentPosition(int agentNo)
        {
         ...
         */
        public XVector2 getAgentPrefVelocity(int agentNo)
        {
         ...
         */
        public XVector2 getAgentVelocity(int agentNo)
        {
         ...
         * retrieved.</param>
         */
        public XVector2 getObstacleVertex(int vertexNo)
        {
         ...
         */
        public bool queryVisibility(XVector2 point1, XVector2 point2, float radius)
        {
         ...
         */
        public void setAgentDefaults(float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, XVector2 velocity)
        {
            if (defaultAgent_ == null)
            {
         ...
         * position.</param>
         */
        public void setAgentPosition(int agentNo, XVector2 position)
        {
         ...
         */
        public void setAgentPrefVelocity(int agentNo, XVector2 prefVelocity)
        {
         ...
         * velocity.</param>
         */
        public void setAgentVelocity(int agentNo, XVector2 velocity)
        {
